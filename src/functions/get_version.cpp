...
namespace duckdb
{
    namespace netquack
    {
        ...
        unique_ptr<LocalTableFunctionState> VersionFunc::InitLocal (ExecutionContext &context, TableFunctionInitInput &input, GlobalTableFunctionState *global_state_p)
        {
